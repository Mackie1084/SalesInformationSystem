...
namespace SalesInformationSystem.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,CustLname,CustFname,Email,Phone,Address")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,CustLname,CustFname,Email,Phone,Address")] Customer customer)
        {
