...
namespace SalesInformationSystem.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InvoiceId,InvoiceDate,TotalAmount,PaymentStatus,CustomerId")] Invoice invoice)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceId,InvoiceDate,TotalAmount,PaymentStatus,CustomerId")] Invoice invoice)
        {
